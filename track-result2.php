...
<br><br>
Info Penerima<br>
Nombor Tracking : <?php echo $row->cons_no; ?> <br>
Tarikh : <?php echo $row->pick_date; ?> <br>
Status : <?php echo $row->status; ?><br><br>

Sila ambil bungkusan anda di pejabat Admin secepat mungkin.<br>
</div>
...
<img border="0" src="http://img.photobucket.com/albums/v486/mafiatrg/blogger_64x64.png" /></a><br />
    ...
    <section class="header">
      ...
      <br><br><br><br><br><br>
      <h1>Track and trace</h1><br><br>
          <h2>Data tidak dijumpai<br>Sila isi semula</h2>
      ...
      <form action="track-result2.php" method="post" name="form" id="form" class="cont">
          ...
          <script language="javascript">
            ...
            <button name="Submit" type="submit" class="srchBtn"  onClick="MM_validateForm('Consignment','','R');return document.MM_returnValue">Search</button>
      </form>
      <!-- end form -->

      <h2>eg:   EF006144864MY</h2></center>
